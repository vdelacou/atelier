...
## Slice 1: a transcript per session (landed, pushed)
...
## Slice 2: the fixture back to three passes at 120 (done: 45, 47, 46 of 61 per pass, 138/183, none refused or capped; release run 61/61 vs 46.0/61; census recorded; committed and pushed on the yes)
