...
| 2.3 | Earn abstractions with the Rule of Three | COVERED | SKILL.md:336; complexity.md:158 | rule | Duplication 1 leave, 2 note, 3 extract |
...
| ID | Sub-concept | Verdict | Evidence | Enforcement | Notes |
|---|---|---|---|---|---|
| 3.1 | Point dependencies inward | COVERED | architecture.md:96; SKILL.md:345 | rule | Domain has zero infra dependencies; imports point inward |
